...
<html lang="en">
  <head>
    ...
    <title>Edit Profile · Dheeraj Mahajan</title>
  ...
  <header class="blog-header py-3">
    ...
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="dheeraj.php">Visit Profile</a>
  ...
  <div>
    <div>
                 ...
                 if(isset($_REQUEST['submitcontent']))
                  {
                    ...
                    $title = $_POST["title"];
                    echo $editcontent;
                    $collectioneditcontent = $db->dheeraj;
                  $collectioneditcontent->updateOne(
                    [ 'title' => $title ],
                    [
                  ...
                  //array('$set'=>array("content"=>$editcontent)));
                    header("Location: edit_dheeraj.php");
          ...
          <div>
                ...
                <input type =text id="contentnewtitle" name="contentnewtitle" style="height:200px"></textarea><br>
                 ...
                 if(isset($_REQUEST['submitnewtitle']))
                  {
                    ...
                    $n_collection = $db->dheeraj;
                    $n_document = [
                                    "title" => $n_title, 
                                    "content" => $n_content,
                    ];
  
                      $n_collection->insertOne($n_document);
                       header("Location: edit_dheeraj.php");
                 ...
                 if(isset($_REQUEST['submitdelete']))
                  {
                    ...
                    $d_collection = $db->dheeraj;
                    $d_collection->deleteOne(["title"=>$d_title]);
                    header("Location: edit_dheeraj.php");
                  }
              ?>
              </div>
